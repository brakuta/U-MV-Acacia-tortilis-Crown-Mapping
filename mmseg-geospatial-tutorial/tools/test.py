...
#   * repository bootstrap so that `geoseg` is importable without installation;
#   * a work directory may be given as checkpoint (resolves best_mIoU_iter_*.pth);
...
from geoseg.checkpoint import resolve_checkpoint
